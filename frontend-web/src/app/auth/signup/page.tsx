  ...
  return (
    <>
      ...
      {successMessage && (
        <div className="bg-green-100 p-3 rounded-md text-center">
          ...
          <p className="text-sm text-green-600">
             Please <Link href="/auth/signin" className="font-semibold underline hover:text-green-800">Sign In</Link>.
          </p>
        </div>
      )}
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="confirmPassword" className="text-sm font-medium text-slate-800">Confirm Password</Label>
          <div className="relative">
            <Input
              id="confirmPassword"
      ...
      <div className="text-center text-sm text-slate-600">
        ...
        <Link href="/auth/signin" className="font-medium text-[#C89B3C] hover:text-[#b88a2c] hover:underline">
          Sign in
        </Link>
      </div>
    </>
